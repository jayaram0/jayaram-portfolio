  ...
  const projects: Project[] = [
    {
      ...
      imageUrl: theme === 'dark' ? "../src/assets/placeholder-dark.svg?height=300&width=500" : "../src/assets/placeholder-light.svg?height=300&width=500",
      githubUrl: "https://github.com",
      liveUrl: "https://example.com",
      gallery: [
        theme === 'dark' ? "../src/assets/placeholder-dark.svg?height=400&width=600" : "../src/assets/placeholder-light.svg?height=400&width=600",
        theme === 'dark' ? "../src/assets/placeholder-dark.svg?height=400&width=600" : "../src/assets/placeholder-light.svg?height=400&width=600",
        theme === 'dark' ? "../src/assets/placeholder-dark.svg?height=400&width=600" : "../src/assets/placeholder-light.svg?height=400&width=600",
      ],
    },
            ...
            <Col xs={24} md={12} key={project.id}>
              <Card
                ...
                cover={
                  <div className="h-48 overflow-hidden">
                    <img
                      alt={project.title}
                      src={project.imageUrl || theme === 'dark' ? "../src/assets/placeholder-dark.svg" : "../src/assets/placeholder-light.svg"}
              ...
              >
                ...
                <div className="mb-4 flex flex-wrap gap-2">
                  ...
                  {project.tags.length > 3 && <Tag color="default">+{project.tags.length - 3}</Tag>}
                </div>
        ...
        >
          {selectedProject && (
            <div>
              ...
              <Paragraph className={`text-lg mb-4 ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
              ...
              <div className="flex gap-4">
                ...
                {selectedProject.liveUrl && (
                  <Button
                    ...
                    target="_blank"
                    className={theme === "dark" ? "border-gray-600 text-white" : ""}
                  >
                    Live Demo
                  </Button>
                )}
