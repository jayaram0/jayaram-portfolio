...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center pt-16 pb-8 px-4 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <Title
          level={1}
          className={`text-4xl sm:text-5xl font-bold mb-4 ${theme === "dark" ? "text-white" : "text-gray-800"}`}
        >
          Jayaram Kinthali
        </Title>

        <Paragraph className={`text-xl mb-8 ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
